...
const DANGEROUS_EXT =
  /\.(exe|dll|bat|cmd|com|msi|scr|jar|app|bin|sh|ps1|vbs|vbe|js|mjs|cjs|wsf|hta|cpl|reg|ade|adp|chm|ins|isp|lib|lnk|mde|pif|scf|sct|shs)$/i;
