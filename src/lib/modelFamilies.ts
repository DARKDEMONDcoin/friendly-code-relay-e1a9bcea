...
import {
  Sparkles, Type, Image as ImageIcon, Edit, Palette,
  Film, Video, Wand2, Scissors, Camera, Mic, Layers,
} from "lucide-react";
...
export const CAPABILITY_META: Record<Capability, { label: string; icon: LucideIcon; short: string }> = {
...
export type ProviderKey =
  | "alibaba" | "vercel" | "bytedance" | "google" | "openai" | "bfl"
  | "recraft" | "kling" | "dashscope" | "qwen" | "gemini" | "flux"
  | "runway" | "luma" | "pika" | "ideogram" | "pixverse" | "minimax"
  | "hailuo" | "stability" | "firefly" | "xai" | "grok" | "sora"
  | "happyhorse";
...
export const MODEL_FAMILIES: ModelFamily[] = [
  // ───── Wan 2.7 ─────
  {
    ...
    provider: "alibaba", providerLabel: "",
    icon: Sparkles, hero: "TOP", unlimitedForSubscribers: true,
    variants: [
      { capability: "t2i",        modelId: "wan-2-7-image-pro", credits: imgMC(0.08), badge: "TOP", note: "4K, multi-ref, 1000-token text" },
      { capability: "t2i",        modelId: "wan-2-7-image",     credits: imgMC(0.04) },
      { capability: "t2v",        modelId: "wan-2-7-t2v",       credits: vidMC(0.15), badge: "TOP", note: "Up to 15s, 1080p with audio" },
      { capability: "i2v",        modelId: "wan-2-7-i2v",       credits: vidMC(0.15), badge: "PRO", note: "First+Last frame, lipsync" },
      { capability: "video-edit", modelId: "wan-2-7-videoedit", credits: vidMC(0.15), badge: "NEW", note: "Outfit / background / object swap" },
    ],
  },
  // ───── Wan 2.1 VACE Plus ─────
  {
    ...
    provider: "alibaba", providerLabel: "",
    icon: Scissors, unlimitedForSubscribers: true,
    variants: [
      { capability: "video-edit", modelId: "wan-2-1-vace-plus", credits: vidMC(0.07) },
    ],
  },
  // ───── HappyHorse 1.0 ─────
  {
    ...
    provider: "alibaba", providerLabel: "",
    icon: Camera, hero: "TOP", unlimitedForSubscribers: true,
    variants: [
      { capability: "t2v",        modelId: "happyhorse-t2v",       credits: vidMC(0.28), badge: "NEW" },
      { capability: "i2v",        modelId: "happyhorse-i2v",       credits: vidMC(0.28), badge: "NEW", note: "Cinematic camera control" },
      { capability: "r2v",        modelId: "happyhorse-r2v",       credits: vidMC(0.28), badge: "TOP", note: "Up to 9 reference images" },
      { capability: "video-edit", modelId: "happyhorse-videoedit", credits: vidMC(0.28), note: "Up to 5 reference images" },
    ],
  },
  // ───── Qwen Image 2.0 ─────
  {
    ...
    provider: "qwen", providerLabel: "",
    icon: Type, unlimitedForSubscribers: true,
    variants: [
      { capability: "t2i",        modelId: "qwen-image-2-0-pro", credits: imgMC(0.075), badge: "PRO", note: "2K, multi-image edit" },
  ...
  // ───── FLUX.2 ─────
  {
    ...
    provider: "bfl", providerLabel: "",
    icon: Sparkles, hero: "TOP", unlimitedForSubscribers: true,
    variants: [
      { capability: "t2i", modelId: "flux-2-max",  credits: imgMC(0.07), badge: "TOP", note: "Up to 10 refs, 4 MP" },
  ...
  // ───── FLUX.2 Klein ─────
  {
    ...
    provider: "bfl", providerLabel: "",
    icon: Sparkles, unlimitedForSubscribers: true,
    variants: [
  ...
  // ───── FLUX Kontext ─────
  {
    ...
    provider: "bfl", providerLabel: "",
    icon: Edit, unlimitedForSubscribers: true,
    variants: [
  ...
  // ───── FLUX Schnell ─────
  {
    ...
    provider: "bfl", providerLabel: "",
    icon: Wand2, unlimitedForSubscribers: true,
    variants: [
      { capability: "t2i", modelId: "flux-fast-schnell", credits: imgMC(0.003) },
    ],
  },
  ...
  // ───── GPT Image 2 ─────
  {
    ...
    provider: "openai", providerLabel: "",
    icon: ImageIcon, unlimitedForSubscribers: true,
    variants: [
  ...
  // ───── GPT Image 1 ─────
  {
    ...
    variants: [
      ...
      { capability: "t2i",        modelId: "gpt-image-1-mini", credits: imgMC(0.01), note: "Cheaper mini tier" },
    ],
  },
  ...
  // ───── Nano Banana Pro ─────
  {
    ...
    provider: "gemini", providerLabel: "",
    icon: Sparkles, hero: "PRO", unlimitedForSubscribers: true,
    variants: [
      { capability: "t2i",        modelId: "gemini-3-pro-image", credits: imgMC(0.15), badge: "TOP", note: "4K + search grounding" },
  ...
  // ───── Seedream 4.5 ─────
  {
    ...
    provider: "bytedance", providerLabel: "",
    icon: Palette, unlimitedForSubscribers: true,
    variants: [
  ...
  // ───── Seedance 2.0 ─────
  {
    ...
    provider: "bytedance", providerLabel: "",
    icon: Film, hero: "TOP", unlimitedForSubscribers: false,
    variants: [
      { capability: "t2v",        modelId: "seedance-2-0",      credits: vidMC(0.30), badge: "TOP", note: "Up to 15s, multimodal refs" },
      { capability: "i2v",        modelId: "seedance-2-0",      credits: vidMC(0.30) },
      { capability: "r2v",        modelId: "seedance-2-0",      credits: vidMC(0.30) },
      { capability: "t2v",        modelId: "seedance-2-0-fast", credits: vidMC(0.15), badge: "PRO", note: "Faster, cheaper tier" },
  ...
  // ───── Seedance 1.0 ─────
  {
    ...
    provider: "bytedance", providerLabel: "",
    icon: Film, unlimitedForSubscribers: false,
    variants: [
      { capability: "t2v", modelId: "seedance-1-0-pro",      credits: vidMC(0.10) },
      { capability: "t2v", modelId: "seedance-1-0-lite-t2v", credits: vidMC(0.05), note: "Lite tier" },
  ...
  // ───── Veo 3.1 ─────
  {
    ...
    provider: "google", providerLabel: "",
    icon: Film, hero: "TOP", unlimitedForSubscribers: false,
    variants: [
      { capability: "t2v", modelId: "veo-3-1",      credits: vidMC(0.40), badge: "TOP", note: "High quality" },
      { capability: "i2v", modelId: "veo-3-1",      credits: vidMC(0.40) },
      { capability: "t2v", modelId: "veo-3-1-fast", credits: vidMC(0.20), badge: "PRO", note: "Faster, cheaper tier" },
      { capability: "i2v", modelId: "veo-3-1-fast", credits: vidMC(0.20) },
    ],
  },
  // ───── Veo 3.0 ─────
  {
    ...
    icon: Film, unlimitedForSubscribers: false,
    variants: [
      { capability: "t2v", modelId: "veo-3-0",      credits: vidMC(0.20) },
      { capability: "i2v", modelId: "veo-3-0",      credits: vidMC(0.20) },
      { capability: "t2v", modelId: "veo-3-0-fast", credits: vidMC(0.10), note: "Faster, cheaper tier" },
      { capability: "i2v", modelId: "veo-3-0-fast", credits: vidMC(0.10) },
    ],
  },
  ...
  // ───── Kling 3.0 ─────
  {
    ...
    provider: "kling", providerLabel: "",
    icon: Camera, unlimitedForSubscribers: false,
    variants: [
      { capability: "t2v", modelId: "kling-v3-0-t2v", credits: vidMC(0.10) },
      { capability: "i2v", modelId: "kling-v3-0-i2v", credits: vidMC(0.10), badge: "PRO", note: "Image-to-video" },
    ],
  },
  // ───── Kling 2.5 Turbo ─────
  {
  ...
  // ───── Recraft V4.1 ─────
  {
    ...
    provider: "recraft", providerLabel: "",
    icon: Palette, unlimitedForSubscribers: true,
    variants: [
      { capability: "t2i", modelId: "recraft-v4-1", credits: imgMC(0.04) },
    ],
  },
];
...
export function pickVariant(family: ModelFamily, inputs: RouteInputs): FamilyVariant | null {
  ...
  if (inputs.hasAudio && (inputs.hasImage || inputs.hasVideo)) return has("lipsync") || has("video-edit") || null;
