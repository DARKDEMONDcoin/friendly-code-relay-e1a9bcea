...
const vi: LandingContent = {
  meta: {
    ...
    description: "Nền tảng AI tất cả trong một: Hơn 80 mô hình cho chat, slides, nghiên cứu chuyên sâu, tạo hình ảnh & video và xây dựng ứng dụng full-stack.",
    keywords: "nền tảng AI, thay thế ChatGPT, công cụ tạo ảnh AI, công cụ tạo video AI, AI slides, nghiên cứu chuyên sâu, trình xây dựng AI full-stack, Nano Banana Pro, GPT-Image 2, Gemini 3 Pro, Veo 3.1",
    ogLocale: "vi_VN",
  },
  hero: {
    h1Pre: "MỘT AI. MỌI CÔNG CỤ",
    h1Highlight: "SÁNG TẠO BẠN CẦN.",
    subtitle: "Chat, slides, nghiên cứu chuyên sâu, hình ảnh, video, điện ảnh, lip-sync và ứng dụng full-stack — được xây dựng trên những mô hình tốt nhất thế giới, hợp nhất trong một không gian làm việc.",
  ...
  chatModels: {
    ...
    subtitle: "Megsy thông minh điều hướng tin nhắn của bạn đến mô hình tốt nhất — hoặc bạn có thể tự chọn thủ công. Chuyển đổi giữa các mô hình ngay trong cuộc hội thoại mà không mất ngữ cảnh.",
    items: [
      {
        name: "Megsy",
  ...
  imageModels: {
    ...
    subtitle: "Năm mô hình hàng đầu cùng hơn 20 công cụ chuyên nghiệp — đổi mặt, ảnh chân dung, xóa nền, chỉnh sáng, hoạt hình hóa và hơn thế nữa.",
    items: [
      {
        name: "Nano Banana Pro",
        cost: "4 MC",
        description: "Chi tiết chân thực, nhân vật nhất quán và phong cách thương hiệu ở chất lượng studio.",
      },
      {
        name: "Nano Banana 2",
        cost: "3 MC",
        description: "Chất lượng thế hệ mới với khả năng tái tạo bàn tay, văn bản và giải phẫu học tiên tiến.",
      },
      {
        name: "GPT-Image 2",
        cost: "5 MC",
        description: "Mô hình hình ảnh hàng đầu của OpenAI — chữ viết hoàn hảo và bối cảnh phức tạp.",
      },
      {
  ...
  codeModels: {
    ...
    subtitle: "Mô tả điều bạn muốn. Megsy Build sẽ tạo frontend React + Tailwind, cơ sở dữ liệu, xác thực, API — và triển khai chúng.",
    steps: [
      {
        title: "Code",
  ...
  howItWorks: {
    ...
    steps: [
      {
        title: "Tạo tài khoản",
        description: "Đăng ký trong vài giây và nhận credit miễn phí để khám phá mọi mô hình ngay lập tức.",
      },
      {
        title: "Chọn công cụ",
        description: "Chat, Studio hình ảnh, Video, Điện ảnh, Slides, Tài liệu, Builder — hãy chọn không gian làm việc của bạn.",
      },
      {
        title: "Chọn mô hình",
      ...
      },
      {
        ...
        description: "Tạo mới, chỉnh sửa, nâng cấp, đổi phong cách. Megsy lưu giữ mọi phiên bản trong thư viện của bạn.",
      },
      {
        title: "Xuất bản & Triển khai",
        description: "Tải xuống ở bất kỳ định dạng nào, xuất bản lên tên miền riêng hoặc chia sẻ lên mạng xã hội.",
      },
    ],
  },
  cta: {
    ...
    subtitle: "Hàng triệu nhà sáng tạo và các đội ngũ đổi mới nhất thế giới tin tưởng Megsy để ra mắt sản phẩm nhanh hơn với sự hoàn thiện và quyền kiểm soát tối đa.",
