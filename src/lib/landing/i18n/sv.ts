...
const sv: LandingContent = {
  meta: {
    ...
    description: "Allt-i-ett AI-plattform: 80+ modeller för chat, slides, djupresearch, bild- och videogenerering samt fullstack-applikationer.",
    keywords: "AI-plattform, ChatGPT-alternativ, AI-bildgenerator, AI-videogenerator, AI-slides, djupresearch, fullstack AI builder, Nano Banana Pro, GPT-Image 2, Gemini 3 Pro, Veo 3.1",
    ogLocale: "sv_SE",
  },
  hero: {
    h1Pre: "En AI. Alla kreativa",
    h1Highlight: "verktyg du behöver.",
    subtitle: "Chat, slides, djupresearch, bilder, videos, bio-kvalitet, läppsynk och fullstack-appar — byggt på världens bästa modeller, samlat i en arbetsyta.",
  ...
  chatModels: {
    ...
    subtitle: "Megsy skickar intelligent ditt meddelande till den bästa modellen — eller välj din favorit manuellt. Byt mitt i konversationen utan att förlora sammanhang.",
    items: [
      {
        name: "Megsy",
  ...
  imageModels: {
    ...
    subtitle: "Fem flaggskeppsmodeller plus 20+ proffsverktyg — face swap, headshots, bakgrundsborttagning, ljussättning och mer.",
    items: [
      {
      ...
      },
      {
        name: "GPT-Image 2",
        cost: "5 MC",
        description: "OpenAIs flaggskeppsmodell för bilder — perfekt typografi och komplexa scener.",
      },
      {
  ...
  codeModels: {
    ...
    subtitle: "Beskriv vad du vill ha. Megsy Build genererar React + Tailwind frontend, databas, autentisering, API — och distribuerar allt.",
    steps: [
      {
        title: "Kod",
    ...
    steps: [
      {
        ...
        description: "Registrera dig på några sekunder och få gratis credits för att utforska alla modeller direkt.",
      },
      {
        title: "Välj ditt verktyg",
        description: "Chat, Image Studio, Video, Cinema, Slides, Dokument, Builder — välj din arbetsyta.",
      },
      {
      ...
      {
        title: "Skapa & iterera",
        description: "Generera, redigera, skala upp, styla om. Megsy sparar varje version i ditt bibliotek.",
      },
      {
        title: "Exportera & publicera",
        description: "Ladda ner i valfritt format, publicera på en egen domän eller dela i sociala medier.",
      },
    ],
  },
  cta: {
    ...
    subtitle: "Miljontals kreatörer och världens mest innovativa team litar på Megsy för att leverera snabbare med finess och kontroll.",
