...
const cs: LandingContent = {
  meta: {
    ...
    description: "Vše v jednom AI platforma: 80+ modelů pro chat, prezentace, hloubkový výzkum, generování obrázků a videa i tvorbu full-stack aplikací.",
    keywords: "AI platforma, alternativa ChatGPT, AI generátor obrázků, AI generátor videa, AI prezentace, hloubkový výzkum, full-stack AI builder, Nano Banana Pro, GPT-Image 2, Gemini 3 Pro, Veo 3.1",
    ogLocale: "cs_CZ",
  },
  hero: {
    h1Pre: "JEDNA AI. KAŽDÝ KREATIVNÍ",
    h1Highlight: "NÁSTROJ, KTERÝ POTŘEBUJETE.",
    subtitle: "Chat, prezentace, hloubkový výzkum, obrázky, videa, kino, lip-sync a full-stack aplikace — postavené na nejlepších světových modelech, sjednocené v jednom pracovním prostoru.",
  ...
  chatModels: {
    ...
    subtitle: "Megsy inteligentně směruje vaši zprávu k nejlepšímu modelu — nebo si vyberte svůj oblíbený ručně. Přepínejte uprostřed konverzace bez ztráty kontextu.",
    items: [
      {
        name: "Megsy",
  ...
  imageModels: {
    ...
    subtitle: "Pět vlajkových modelů a více než 20 profesionálních nástrojů — face swap, portréty, odstranění pozadí, nasvícení, cartoonify a další.",
    items: [
      {
        name: "Nano Banana Pro",
        cost: "4 MC",
        description: "Fotorealistické detaily, konzistentní postavy a studiová kvalita ve stylu značky.",
      },
      {
        name: "Nano Banana 2",
        cost: "3 MC",
  ...
  codeModels: {
    ...
    subtitle: "Popište, co chcete. Megsy Build vygeneruje React + Tailwind frontend, databázi, autentizaci, API — a vše nasadí.",
    steps: [
      {
        title: "Kód",
      ...
      {
        title: "Rychlost",
        description: "Buildy optimalizované pro Lighthouse, lazy loading a komprese obrázků v ceně.",
      },
      {
        title: "Bezpečnost",
    ...
    steps: [
      {
        ...
        description: "Zaregistrujte se během několika sekund a získejte kredity zdarma k okamžitému vyzkoušení každého modelu.",
      },
      {
        title: "Vyberte si nástroj",
        description: "Chat, Image Studio, Video, Kino, Prezentace, Dokumenty, Builder — vyberte si svůj pracovní prostor.",
      },
      {
        title: "Zvolte model",
      ...
      },
      {
        ...
        description: "Generujte, upravujte, zvětšujte rozlišení, měňte styl. Megsy uchovává každou verzi ve vaší knihovně.",
      },
      {
        title: "Exportujte a nasaďte",
        description: "Stahujte v libovolném formátu, publikujte na vlastní doménu nebo sdílejte na sociálních sítích.",
      },
    ],
  },
  cta: {
    line1: "DŮVĚŘUJÍ NÁM",
    line2: "PŘEDNÍ TVŮRCI",
    subtitle: "Miliony tvůrců a nejinovativnější týmy světa věří Megsy pro rychlejší dodávání projektů s precizností a kontrolou.",
