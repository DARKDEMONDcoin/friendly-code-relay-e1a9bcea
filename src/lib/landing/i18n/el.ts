...
const el: LandingContent = {
  meta: {
    ...
    description: "Όλα-σε-ένα πλατφόρμα AI: 80+ μοντέλα για chat, slides, βαθιά έρευνα, παραγωγή εικόνας & βίντεο και δημιουργία full-stack εφαρμογών.",
    keywords: "πλατφόρμα AI, εναλλακτική λύση ChatGPT, AI γεννήτρια εικόνων, AI γεννήτρια βίντεο, AI slides, βαθιά έρευνα, full-stack AI builder, Nano Banana Pro, GPT-Image 2, Gemini 3 Pro, Veo 3.1",
    ogLocale: "el_GR",
  },
  hero: {
    h1Pre: "ΜΙΑ AI. ΚΑΘΕ ΔΗΜΙΟΥΡΓΙΚΟ",
    h1Highlight: "ΕΡΓΑΛΕΙΟ ΠΟΥ ΧΡΕΙΑΖΕΣΤΕ.",
    subtitle: "Chat, slides, βαθιά έρευνα, εικόνες, βίντεο, κινηματογραφική ποιότητα, lip-sync και full-stack εφαρμογές — χτισμένα στα κορυφαία μοντέλα του κόσμου, ενοποιημένα σε έναν χώρο εργασίας.",
  ...
  chatModels: {
    ...
    subtitle: "Το Megsy δρομολογεί έξυπνα το μήνυμά σας στο καλύτερο μοντέλο — ή επιλέξτε το αγαπημένο σας χειροκίνητα. Αλλάξτε μοντέλο στη μέση της συνομιλίας χωρίς να χάσετε το πλαίσιο.",
    items: [
      {
        name: "Megsy",
      ...
      },
      {
        name: "GPT-5",
        tag: "OpenAI",
        description: "Κορυφαία συλλογιστική, κωδικοποίηση και συγγραφή κειμένων μεγάλου περιεχομένου.",
      },
      {
        name: "Gemini 2.5 Pro",
        tag: "Google",
  ...
  imageModels: {
    ...
    subtitle: "Πέντε κορυφαία μοντέλα συν 20+ επαγγελματικά εργαλεία — face swap, headshots, αφαίρεση φόντου, relight, cartoonify και πολλά άλλα.",
    items: [
      {
        name: "Nano Banana Pro",
        cost: "4 MC",
        description: "Φωτορεαλιστική λεπτομέρεια, συνεπείς χαρακτήρες και στυλ επωνυμίας σε ποιότητα στούντιο.",
      },
      {
        name: "Nano Banana 2",
        cost: "3 MC",
        description: "Ποιότητα επόμενης γενιάς με προηγμένη απόδοση χεριών, κειμένου και ανατομίας.",
      },
      {
        name: "GPT-Image 2",
        cost: "5 MC",
        description: "Το κορυφαίο μοντέλο εικόνας της OpenAI — τέλεια τυπογραφία και σύνθετες σκηνές.",
      },
      {
        name: "Gemini 3 Pro Image",
        cost: "5 MC",
        description: "Η κορυφαία γεννήτρια εικόνας της Google με κινηματογραφική σύνθεση και φωτισμό.",
      },
      {
        name: "Nano Banana",
        cost: "2 MC",
  ...
  codeModels: {
    ...
    subtitle: "Περιγράψτε τι θέλετε. Το Megsy Build δημιουργεί το React + Tailwind frontend, τη βάση δεδομένων, το auth, το API — και κάνει το deployment.",
    steps: [
      {
        title: "Κώδικας",
    ...
    steps: [
      {
        ...
        description: "Εγγραφή σε δευτερόλεπτα και δωρεάν credits για να εξερευνήσετε κάθε μοντέλο αμέσως.",
      },
      {
        title: "Επιλέξτε εργαλείο",
        description: "Chat, Image Studio, Video, Cinema, Slides, Docs, Builder — διαλέξτε τον χώρο εργασίας σας.",
      },
      {
      ...
      },
      {
        ...
        description: "Δημιουργήστε, επεξεργαστείτε, αναβαθμίστε την ποιότητα. Το Megsy κρατά κάθε έκδοση στη βιβλιοθήκη σας.",
      },
      {
        title: "Εξαγωγή & Deploy",
        description: "Λήψη σε οποιαδήποτε μορφή, δημοσίευση σε προσαρμοσμένο domain ή κοινή χρήση στα social media.",
      },
    ],
  },
  cta: {
    ...
    subtitle: "Εκατομμύρια δημιουργοί και οι πιο καινοτόμες ομάδες του κόσμου εμπιστεύονται το Megsy για ταχύτερη υλοποίηση με ποιότητα και έλεγχο.",
