...
const pl: LandingContent = {
  meta: {
    ...
    description: "Wszechstronna platforma AI: ponad 80 modeli do czatu, prezentacji, głębokiego researchu, generowania obrazów i wideo oraz budowania aplikacji full-stack.",
    keywords: "platforma AI, alternatywa dla ChatGPT, generator obrazów AI, generator wideo AI, prezentacje AI, głęboki research, kreator aplikacji full-stack AI, Nano Banana Pro, GPT-Image 2, Gemini 3 Pro, Veo 3.1",
    ogLocale: "pl_PL",
  },
  hero: {
    h1Pre: "JEDNO AI. KAŻDE NARZĘDZIE",
    h1Highlight: "KTÓREGO POTRZEBUJESZ.",
    subtitle: "Czat, slajdy, głęboki research, obrazy, wideo, kino, lip-sync i aplikacje full-stack — oparte na najlepszych modelach świata, zintegrowane w jednym obszarze roboczym.",
  ...
  chatModels: {
    ...
    subtitle: "Megsy inteligentnie kieruje Twoją wiadomość do najlepszego modelu — możesz też wybrać go ręcznie. Przełączaj się w trakcie rozmowy bez utraty kontekstu.",
    items: [
      {
        name: "Megsy",
      ...
      },
      {
        name: "Grok",
        tag: "xAI",
        description: "Wiedza internetowa w czasie rzeczywistym z błyskotliwym, nieocenzurowanym stylem.",
      },
      {
        name: "DeepSeek",
        tag: "Open-source",
  ...
  imageModels: {
    ...
    subtitle: "Pięć flagowych modeli plus ponad 20 profesjonalnych narzędzi — face swap, zdjęcia profilowe, usuwanie tła, zmiana oświetlenia, cartoonify i więcej.",
    items: [
      {
      ...
      },
      {
        name: "Nano Banana 2",
        cost: "3 MC",
        description: "Jakość nowej generacji z najnowocześniejszym odwzorowaniem dłoni, tekstu i anatomii.",
      },
      {
        name: "GPT-Image 2",
        cost: "5 MC",
  ...
  codeModels: {
    ...
    subtitle: "Opisz to, czego potrzebujesz. Megsy Build wygeneruje frontend React + Tailwind, bazę danych, autoryzację, API i wdroży całość.",
    steps: [
      {
        title: "Kod",
      ...
      },
      {
        ...
        description: "Polityki RLS, zarządzanie sekretami i skanowanie zależności przy każdej zmianie.",
      },
      {
        title: "Publikacja",
  ...
  howItWorks: {
    ...
    steps: [
      {
        title: "Utwórz konto",
        description: "Zarejestruj się w kilka sekund i odbierz darmowe kredyty, aby od razu przetestować każdy model.",
      },
      {
        title: "Wybierz narzędzie",
        description: "Czat, Studio Obrazu, Wideo, Kino, Slajdy, Dokumenty, Kreator — wybierz swój obszar pracy.",
      },
      {
        title: "Wybierz model",
      ...
      },
      {
        ...
        description: "Generuj, edytuj, powiększaj, zmieniaj styl. Megsy zapisuje każdą wersję w Twojej bibliotece.",
      },
      {
        title: "Eksportuj i wdrażaj",
        description: "Pobieraj w dowolnym formacie, publikuj na własnej domenie lub udostępniaj w mediach społecznościowych.",
      },
    ],
  },
  cta: {
    ...
    subtitle: "Miliony twórców i najbardziej innowacyjne zespoły świata ufają Megsy, aby publikować szybciej, z pełną kontrolą i jakością.",
