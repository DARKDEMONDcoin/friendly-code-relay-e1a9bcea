    ...
    <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-6">
      ...
      >
        ...
        <div
          ...
          style={{ background: "radial-gradient(circle, rgba(217,91,60,0.35) 0%, transparent 70%)" }}
        />
        ...
        <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="space-y-3 max-w-2xl">
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur text-xs font-semibold tracking-wide uppercase border border-white/10">
              <MegsyStar size={14} static className="text-[#facc15]" />
              Limited time offer
            </span>
            ...
            <p className="text-white/80 text-sm sm:text-base leading-relaxed">
              Subscribe within the next 3 days and get unlimited Chat, Images,
              Videos, Slides, Docs, Deep Research and Code Builder for your
              entire first month — plus 50% OFF on every plan. After this
              offer ends, plans return to standard usage windows.
            </p>
          </div>
