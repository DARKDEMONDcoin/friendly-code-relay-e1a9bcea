      ...
      <div className="mx-auto max-w-[1700px] px-5 md:px-12">
        ...
        >
          <h2
            ...
            className="uppercase tracking-tighter text-foreground leading-[0.85] text-[16vw] md:text-[15vw]"
          >
            EXPLORE
          </h2>
          <h3
            style={{ fontFamily: '"Dela Gothic One", sans-serif' }}
            className="uppercase tracking-tight text-foreground leading-[0.95] text-[5.5vw] md:text-[5vw] mt-2 md:mt-2"
          >
            MORE AI CREATIVE TOOLS
          </h3>
          <p className="mt-4 md:mt-6 mx-auto max-w-2xl text-[13px] md:text-base text-foreground/80 leading-snug">
            Megsy is more than an AI image platform. Work across image, video, design, and motion
            with tools built for modern creative production.
          </p>
        </motion.div>
      </div>
        ...
        >
          {services.map((item, i) => (
            ...
            >
              ...
              <h3
                style={{ fontFamily: '"Dela Gothic One", sans-serif' }}
                className="mt-5 text-xl md:text-2xl text-foreground leading-tight"
              >
                {item.label}
              </h3>
