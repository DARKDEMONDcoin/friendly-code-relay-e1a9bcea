    ...
    <section className="relative overflow-hidden py-20 md:py-32 bg-red-700">
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-foreground/50 md:text-lg">{c.subtitle}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 gap-4 md:auto-rows-[180px] md:grid-cols-4">
          ...
          {s4 && (
            ...
            >
              ...
              <div>
                <h3 className="font-display text-xl font-black uppercase text-foreground">{s4.title}</h3>
