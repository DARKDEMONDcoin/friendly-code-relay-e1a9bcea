...
const IMAGE_MODELS: Card[] = [
  {
    ...
    title: "Nano Banana",
    meta: "2 MC",
    description: "Lightning-fast generation for ideation and iteration.",
    Icon: ImageIcon,
  },
  {
    category: "Image Models",
    ...
    meta: "4 MC",
    description: "Photorealistic detail with consistent characters and style.",
    Icon: Camera,
  },
  {
    category: "Image Models",
    title: "Nano Banana 2",
    meta: "3 MC",
    description: "Next-gen quality with improved hands, text, and anatomy.",
    Icon: Sparkles,
  },
  {
    category: "Image Models",
    title: "Flux Schnell",
    meta: "2 MC",
    description: "Open-source speed champion for high-volume creative work.",
    Icon: Wand2,
  },
  {
    category: "Image Models",
    title: "Flux Pro",
    meta: "5 MC",
    description: "Studio-grade quality for hero images, ads, and posters.",
    Icon: Brush,
  },
];
...
const VIDEO_MODELS: Card[] = [
  {
    ...
    title: "Veo 3",
    meta: "12 MC",
    description: "Cinematic 1080p video with synced audio and long shots.",
    Icon: Film,
  },
  {
    category: "Video Models",
    title: "Kling 2.0",
    meta: "8 MC",
    description: "Smooth motion and realistic physics for character animation.",
    Icon: Film,
  },
  {
    category: "Video Models",
    title: "Runway Gen-3",
    meta: "10 MC",
    description: "Premium text-to-video with director-level camera controls.",
    Icon: Film,
  },
  {
    category: "Video Models",
    title: "Hailuo 02",
    meta: "6 MC",
    description: "Fast generation with strong prompt adherence for storyboards.",
    Icon: Film,
  },
  {
    category: "Video Models",
    title: "Sora",
    meta: "14 MC",
    description: "Hyper-real long-form clips with consistent scene continuity.",
    Icon: Film,
  },
];
...
const TOOLS: Card[] = [
  {
    ...
    title: "Face Swap",
    meta: "Image",
    description: "Swap any face into any photo while preserving lighting and pose.",
    Icon: ScanFace,
  },
  {
    category: "Tools",
    ...
    meta: "Image",
    description: "One-click cutouts with clean, hair-accurate alpha masks.",
    Icon: Eraser,
  },
  {
    category: "Tools",
    title: "Relight",
    meta: "Image",
    description: "Re-light any portrait with studio, neon, or natural setups.",
    Icon: Sun,
  },
  {
    category: "Tools",
    title: "Upscale 4K",
    meta: "Image · Video",
    description: "Boost resolution and sharpness on photos and clips.",
  ...
  },
  {
    ...
    meta: "Image",
    description: "Restyle any image into anime, oil paint, 3D, or your brand look.",
    Icon: Palette,
  },
  {
    category: "Tools",
    title: "Video Inpaint",
    meta: "Video",
    description: "Remove objects, logos, or people from any video frame.",
    Icon: Scissors,
  },
];
            ...
            {filtered.slice(0, 5).map((card, i) => {
              return (
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-foreground/55">{card.description}</p>
                </motion.article>
              );
            })}
            <motion.article
