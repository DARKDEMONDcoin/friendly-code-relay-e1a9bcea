      ...
      <div className="mx-auto max-w-6xl px-5 md:px-6">
        ...
        >
          <h3
            ...
            className="text-3xl uppercase leading-[0.95] tracking-tight text-foreground md:text-5xl"
          >
            Every mode, one Megsy
          </h3>
          <p className="mx-auto mt-3 max-w-2xl text-[13px] text-foreground/60 md:text-base">
            Switch between specialized modes — research, learning, shopping, slides, autonomous OS
            and more — all inside one chat.
          </p>
        </motion.div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <h4
                  ...
                  className="text-3xl uppercase text-foreground md:text-5xl"
                >
                  {current.brand}
                </h4>
                ...
                <p
                  style={{ fontFamily: '"Dela Gothic One", sans-serif' }}
                  className="mx-auto mt-8 max-w-md whitespace-pre-line text-xl leading-tight text-foreground md:text-3xl"
                >
                  {current.title}
                </p>

                <p className="mx-auto mt-5 max-w-md text-sm leading-relaxed text-foreground/55 md:text-base">
                  {current.description}
                </p>

                <button
                  onClick={() => navigate(current.href)}
                  className="mt-8 rounded-full border border-white/25 px-7 py-3 text-sm font-medium text-foreground transition hover:border-white/60 hover:bg-white/5"
                >
                  {current.cta}
                </button>
              </motion.div>
