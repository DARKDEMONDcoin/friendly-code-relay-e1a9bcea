...
const VARIANT_GRADIENTS: Record<GlowVariant, string> = {
  ...
  pro:
    "conic-gradient(from var(--glow-angle), #1e64ff 0deg, #60a5fa 70deg, #bfdbfe 95deg, #60a5fa 130deg, #1e64ff 220deg, #1e64ff 360deg)",
  elite:
...
const GlowButton = forwardRef<HTMLButtonElement, GlowButtonProps>(
  ({ variant = "gold", className = "", innerBg = "hsl(var(--card))", children, style, ...rest }, ref) => {
