...
const LANG_LABEL: Record<string, string> = {
  ...
  sql: "SQL", rs: "Rust", go: "Go", java: "Java", c: "C", cpp: "C++",
  cs: "C#", php: "PHP", rb: "Ruby", yml: "YAML", yaml: "YAML", xml: "XML",
  diff: "Diff", dockerfile: "Dockerfile", toml: "TOML", swift: "Swift",
  kotlin: "Kotlin", dart: "Dart",
};

const LANG_ALIAS: Record<string, string> = {
  js: "javascript", jsx: "jsx", ts: "typescript", tsx: "tsx",
  py: "python", sh: "bash", zsh: "bash", yml: "yaml",
  rs: "rust", cs: "csharp",
};
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "inset 0 0 0 1px hsl(var(--foreground) / 0.08), 0 20px 50px -28px hsl(0 0% 0% / 0.6)",
      }}
      dir="ltr"
    >
      {/* Header */}
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-[11px] font-medium tracking-wide uppercase text-muted-foreground truncate">
            {label}
          </span>
        ...
        <div className="flex items-center gap-0.5">
          <button
            ...
            className={`inline-flex items-center justify-center w-7 h-7 rounded-md transition-colors ${
              wrap ? "text-indigo-300 bg-indigo-500/10" : "text-muted-foreground hover:text-foreground"
            }`}
      ...
      >
        ...
        {showCollapsed && (
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, transparent, hsl(var(--card) / 0.95))",
            }}
          />
        )}
      </div>
