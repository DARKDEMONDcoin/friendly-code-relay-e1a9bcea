        ...
        <div className="shrink-0 border-t border-white/10 bg-black/40 backdrop-blur px-4 py-3 flex items-center justify-center gap-2">
          {onDownloadPdf && (
            <button
              ...
              className="h-10 px-4 rounded-full bg-white text-foreground inline-flex items-center gap-2 text-[13px] font-semibold hover:opacity-90"
              aria-label="Download"
            >
          ...
          <button
            onClick={handleShare}
            className="h-10 px-4 rounded-full bg-white/10 hover:bg-white/20 text-foreground inline-flex items-center gap-2 text-[13px] font-medium"
            aria-label="Share"
          >
