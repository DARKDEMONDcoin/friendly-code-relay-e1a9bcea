...
function pickBrand(name = "", provider = ""): LobeIcon | null {
  ...
  if (n.includes("gpt") || n.includes("openai") || n.includes("dall") || n.includes("sora")) return OpenAI;
  if (n.includes("seedream") || n.includes("seedance") || n.includes("doubao")) return Doubao;
  if (n.includes("wanx") || n.includes("wan ") || n.includes("qwen") || n.includes("alibaba")) return Alibaba;
