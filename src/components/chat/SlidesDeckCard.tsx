      ...
      <div className="mt-3 group relative max-w-[420px] rounded-ios-xl overflow-hidden bg-zinc-950 border border-white/5 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.6)] transition-all duration-700 hover:border-white/10">
        ...
        <div className="px-6 pb-6 pt-4 flex flex-col gap-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3.5 bg-white text-foreground font-semibold rounded-2xl transition-all active:scale-[0.97] hover:bg-zinc-100 shadow-lg text-[14px] tracking-tight"
          >
