          ...
          <div className="flex items-center justify-between gap-3 px-4 pb-4">
            <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide">
              ...
              <button
                ...
                className={
                  "shrink-0 flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-black bg-[#C9A8FF] border-2 border-brand-ink text-brand-ink shadow-[2px_2px_0_rgba(201,168,255,0.30)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all"
                }
              >
                {logo && (
                  <img
