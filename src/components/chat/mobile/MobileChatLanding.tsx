...
const VideoGlyph = ({ className }: GlyphProps) => (
  <svg {...glyphBase} className={className}>
    ...
    <path d="M10.4 9.2l4.4 2.8-4.4 2.8z" fill="currentColor" stroke="currentColor" strokeWidth="1.2" />
  </svg>
);
...
export const DEFAULT_LANDING_CHIPS: LandingChip[] = [
  { id: "website", label: "Create Website" },
...
export const DEFAULT_LANDING_MODELS: LandingModel[] = [
  { id: "megsy-lite", label: "Megsy Lite", sub: "Fast everyday model", icon: <MegsyIcon /> },
  { id: "megsy-pro", label: "Megsy Pro", sub: "Balanced quality", icon: <MegsyIcon /> },
  { id: "megsy-max", label: "Megsy Max", sub: "Most capable", pro: true, icon: <MegsyIcon /> },
  {
    id: "claude-opus-4.8",
  ...
  { id: "kimi-2.6", label: "Kimi 2.6", sub: "Free · Moonshot", icon: <Kimi.Color size={20} /> },
  {
    id: "deepseek",
    label: "DeepSeek",
    sub: "Free · reasoning",
...
type ConnectItem = { id: string; name: string; domain: string; description: string; category?: string };
const CONNECT_ITEMS: ConnectItem[] = [
  { id: "github", name: "GitHub", domain: "github.com", description: "Browse repos, issues and pull requests.", category: "Development" },
  { id: "supabase", name: "Supabase", domain: "supabase.com", description: "Manage your database, auth and edge functions.", category: "Development" },
  { id: "vercel", name: "Vercel", domain: "vercel.com", description: "Deploy and inspect production projects.", category: "Deployment" },
  { id: "notion", name: "Notion", domain: "notion.so", description: "Search pages and update docs in your workspace.", category: "Productivity" },
  { id: "linear", name: "Linear", domain: "linear.app", description: "Create issues and track sprints in seconds.", category: "Productivity" },
  { id: "gmail", name: "Gmail", domain: "gmail.com", description: "Draft replies and search your inbox from chat.", category: "Communication" },
  { id: "slack", name: "Slack", domain: "slack.com", description: "Send messages and fetch channel context.", category: "Communication" },
  { id: "discord", name: "Discord", domain: "discord.com", description: "Bridge your servers and channels with the agent.", category: "Communication" },
  { id: "figma", name: "Figma", domain: "figma.com", description: "Pull frames and turn designs into code.", category: "Design" },
  { id: "drive", name: "Google Drive", domain: "drive.google.com", description: "Search, read and upload files instantly.", category: "Storage" },
  { id: "dropbox", name: "Dropbox", domain: "dropbox.com", description: "Access shared folders and recent uploads.", category: "Storage" },
  { id: "stripe", name: "Stripe", domain: "stripe.com", description: "Inspect customers, charges and subscriptions.", category: "Payments" },
  { id: "x", name: "X", domain: "x.com", description: "Post updates and pull trending threads.", category: "Social" },
  { id: "instagram", name: "Instagram", domain: "instagram.com", description: "Publish posts and read insights.", category: "Social" },
  { id: "youtube", name: "YouTube", domain: "youtube.com", description: "Search videos and fetch transcripts.", category: "Social" },
  { id: "telegram", name: "Telegram", domain: "telegram.org", description: "Send and receive messages across chats.", category: "Communication" },
];
...
const MobileChatLanding = ({
  ...
  void models; void selectedModelId; void onModelSelect; void isPaid;
  ...
  void agentCards; void onAgentClick;
          ...
          <div className="flex flex-col items-center justify-center gap-4 w-full max-w-sm">
            ...
            {!isReactive && (
              <motion.h1
                ...
                className="text-[40px] leading-[1.0] tracking-tight"
                style={{ fontWeight: 900, color: "hsl(var(--brand-parchment))", letterSpacing: "-0.03em" }}
              >
                Let's build{firstName && firstName !== "there" ? `, ${firstName}` : ""}!
              </motion.h1>
            )}

            {/* Subline with bright color highlights */}
            {!isReactive && (
              <motion.p
                ...
                style={{ color: "hsl(var(--brand-muted))", fontWeight: 600 }}
              >
                Create{" "}
                <span style={{ color: "hsl(var(--brand-action))", fontWeight: 900 }}>websites</span>,{" "}
                <span style={{ color: "hsl(var(--brand-mint))", fontWeight: 900 }}>images</span> &{" "}
                <span style={{ color: "#C9A8FF", fontWeight: 900 }}>videos</span> — all in one chat.
              </motion.p>
            )}
          </div>
        </div>
              ...
              return (
                <li key={it.id} className="flex items-center gap-3 px-5 py-3.5">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[12px] text-white/55 line-clamp-2">
                      {it.description}
                    </p>
                  </div>
                  <button
