  ...
  return (
    <>
      <div
        ...
        className="md:hidden fixed inset-x-0 z-30 flex items-center gap-2 px-3 py-1.5 min-h-[44px] pt-[max(env(safe-area-inset-top),0.25rem)] bg-transparent pointer-events-none [&>*]:pointer-events-auto"
      >
        <button
          type="button"
        ...
        {modelSlot ? (
          <div className="flex items-center">{modelSlot}</div>
        ) : null}
        ...
        {!hasConversation && (
          ...
          >
            ...
            <span className="text-[12.5px] font-black leading-none whitespace-nowrap">Get Plus</span>
          </Link>
        )}
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="md:hidden fixed right-3 z-50 w-[280px] rounded-ios-lg overflow-hidden bg-card border border-border shadow-[0_22px_48px_-16px_rgba(0,0,0,0.55),0_2px_6px_rgba(0,0,0,0.25)]"
              dir="rtl"
            >
