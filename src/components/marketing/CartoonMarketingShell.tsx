...
export function CartoonContainer({ children, className = "" }: { children: ReactNode; className?: string }) {
  return (
...
export function PillButton({
  ...
  const sharedClass =
    `inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-[14px] transition active:translate-x-[2px] active:translate-y-[2px] active:shadow-none disabled:opacity-50 disabled:cursor-not-allowed ${className}`;
