...
export const AccountIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    ...
    <path
      d="M14 10h4.5M14 12.5h4.5M14 15h3"
      stroke="currentColor"
      strokeWidth="1.4"
      strokeLinecap="round"
    />
...
export const MemoryIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    ...
    <path
      d="M12.6 4.2a3.2 3.2 0 0 1 5.4 2.1A3 3 0 0 1 20 9.2a2.8 2.8 0 0 1-.7 1.9A2.8 2.8 0 0 1 20 13a2.9 2.9 0 0 1-1.6 2.6A3 3 0 0 1 16 19.8a3.1 3.1 0 0 1-3.4-2.2z"
      opacity="0.55"
    />
...
export const SupportIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    ...
    <path
      d="M9.7 9.7L6 6M14.3 9.7L18 6M9.7 14.3L6 18M14.3 14.3L18 18"
      stroke="currentColor"
      strokeWidth="1.6"
      strokeLinecap="round"
    />
...
export const FAQIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    <path
      d="M4 4.5A1.5 1.5 0 0 1 5.5 3H18a2 2 0 0 1 2 2v14a1 1 0 0 1-1.5.9L17 19l-1.5.9A1 1 0 0 1 14 19V5H5.5A1.5 1.5 0 0 1 4 4.5z"
      opacity="0.25"
    />
    <path d="M4 4.5A1.5 1.5 0 0 1 5.5 3H14v16.5a1.5 1.5 0 0 1-1.5 1.5h-7A1.5 1.5 0 0 1 4 19.5z" />
    <path
      d="M7 8h4M7 11h4M7 14h3"
      stroke="#fff"
      strokeWidth="1.1"
      strokeLinecap="round"
      fill="none"
...
export const HumanSupportIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    <path
      d="M5 13.5v-1A7 7 0 0 1 19 12.5v1"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.7"
      strokeLinecap="round"
    ...
    <path
      d="M16.5 17h-1.2a3 3 0 0 1-3 3H11"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.4"
      strokeLinecap="round"
...
export const LanguageIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    ...
    <path
      d="M14.5 9.5h5A1.5 1.5 0 0 1 21 11v6a1.5 1.5 0 0 1-1.5 1.5H19v2c0 .7-.8 1-1.3.6L14.5 18.5h-3a1.5 1.5 0 0 1-1.5-1.5v-2.4a3 3 0 0 0 2-.6h3a3 3 0 0 0 3-3z"
      opacity="0.45"
    />
...
export const StatusIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    ...
    <path
      d="M8.5 15.5a5 5 0 0 1 0-7l-1.4-1.4a7 7 0 0 0 0 9.8zM15.5 8.5a5 5 0 0 1 0 7l1.4 1.4a7 7 0 0 0 0-9.8z"
      opacity="0.7"
    />
    <path
      d="M5.6 18.4a9 9 0 0 1 0-12.8L4.2 4.2a11 11 0 0 0 0 15.6zM18.4 5.6a9 9 0 0 1 0 12.8l1.4 1.4a11 11 0 0 0 0-15.6z"
      opacity="0.4"
    />
  </svg>
);
