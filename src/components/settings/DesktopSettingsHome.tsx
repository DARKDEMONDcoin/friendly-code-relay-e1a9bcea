    ...
    <div className="grid grid-cols-6 gap-6">
      ...
      <div className="col-span-6 md:col-span-4 rounded-3xl border border-border bg-card p-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <FieldTile
            label="Account Type"
            value={account.kind === "workspace" ? "Workspace" : "Personal"}
          />
        </div>
      </div>
      ...
      >
        ...
        <div className="flex flex-wrap gap-2">
          {["All AI models", "Memory", "Skills"].map((f) => (
            <span
              key={f}
              className="inline-flex items-center gap-1 text-xs text-muted-foreground bg-secondary/60 px-2.5 py-1 rounded-md"
            >
      ...
      <QuickTile
        ...
        desc="Tune AI behavior & tone"
        icon={AiPersonalizationIcon}
        onClick={() => navigate("/settings/ai-personalization")}
      />
      <QuickTile
        title="Memory"
        desc="What Megsy remembers"
        icon={MemoryIcon}
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          Email alerts, mentions & product news preferences.
        </p>
      </button>
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          Export your data, control memory, or delete your account.
        </p>
      </button>
    </div>
  );
