          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-center px-6 -mt-8">
              <div className="text-center">
                <h1 className="text-[28px] font-black tracking-tight text-brand-parchment">Continue with email</h1>
              ...
              >
              <div>
                <label className="block text-[11px] text-brand-muted mb-2 px-1 font-black uppercase tracking-wider">Email</label>
              ...
              <AnimatePresence>
                {p.showPasswordField && (
                  ...
                  >
                    <label className="block text-[11px] text-brand-muted mb-2 px-1 font-black uppercase tracking-wider">Password</label>
                    ...
                    <div className="flex justify-end mt-2">
                      <button type="button" onClick={p.onForgotPassword} className="text-[12px] text-brand-action font-bold underline underline-offset-4">
                        Forgot Password?
                      </button>
                    </div>
                  </motion.div>
