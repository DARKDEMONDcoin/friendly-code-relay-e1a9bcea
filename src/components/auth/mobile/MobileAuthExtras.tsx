...
const gradientStyle = {
  background: "linear-gradient(90deg,hsl(var(--brand-charcoal)) 0%,hsl(var(--brand-slate)) 50%,hsl(var(--brand-silver)) 100%)",
};
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center px-6 -mt-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-[13px] text-white/85 break-words">
                {meta.sub(p.email)}
              </p>
            </div>
