        ...
        <>
          ...
          >
            ...
            >
              <button
                ...
                style={{ backgroundColor: YELLOW, border: `2px solid ${INK}`, boxShadow: `2px 2px 0 ${INK}` }}
                aria-label="Back"
              >
                    ...
                    >
                      ...
                      >
                        ...
                        {active && (
                          ...
                          >
                            <Check className="h-3.5 w-3.5" strokeWidth={3} style={{ color: YELLOW }} />
                          </span>
                        )}
                      </div>
                      {t.name && (
            ...
            >
              <button
                ...
                style={{ backgroundColor: SURFACE_2, color: TEXT, border: `2px solid ${INK}`, boxShadow: `2px 2px 0 ${INK}` }}
              >
                Cancel
              </button>
              <button
          ...
          >
            ...
            >
              ...
              {/* Grid */}
              <div className="flex-1 overflow-y-auto px-6 py-5" style={{ backgroundColor: PAGE_BG }}>
                      ...
                      >
                        ...
                        {t.name && (
                          <div className="px-3 py-2.5">
                            ...
                            {t.description && (
                              <p className="text-[11px] truncate mt-0.5" style={{ color: active ? INK : MUTED, opacity: active ? 0.7 : 1 }}>
                                {t.description}
                              </p>
                            )}
                          </div>
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    style={{ backgroundColor: SURFACE, color: TEXT, border: `2px solid ${INK}`, boxShadow: `2px 2px 0 ${INK}` }}
                  >
                    Cancel
                  </button>
                  <button
