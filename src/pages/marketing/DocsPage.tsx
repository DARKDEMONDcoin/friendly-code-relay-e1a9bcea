    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "p", text: "Every paid plan can be billed yearly. You pay for 10 months and get 12 — the equivalent of 2 free months — plus a one-time bonus MC grant deposited the day your yearly term starts. The bonus never expires. Switching monthly → yearly mid-cycle is prorated automatically; you only pay the difference." },
          { kind: "kv", rows: [
            { k: "Pro yearly — $250/yr (≈ $20.83/mo)", v: "Save $50 vs monthly + 480 bonus MC up front. Effective 17% discount." },
            { k: "Elite yearly — $590/yr (≈ $49.17/mo)", v: "Save $118 vs monthly + 1,000 bonus MC up front. Effective 17% discount." },
            { k: "Business yearly — $1,490/yr (≈ $124.17/mo)", v: "Save $298 vs monthly + 2,400 bonus MC up front. Effective 17% discount." },
            { k: "Enterprise yearly", v: "Custom multi-year contracts with volume discounts, POs, NET-30 invoicing and lock-in pricing — talk to sales at /enterprise." },
          ]},
          { kind: "note", text: "Yearly subscriptions renew automatically on the same date next year. You can switch back to monthly or cancel any time from /settings/billing — access continues until the paid period ends and any remaining MC top-ups stay yours." },
