...
const features = [
  {
    ...
    title: "AI Chat",
    sub: "Megsy V1",
    desc: "Conversational AI with web search, deep research and file upload — built on top of 36+ underlying engines.",
  },
  {
    n: "02",
    title: "Image Generation",
    sub: "Megsy Imagine",
    desc: "Text-to-image and image-to-image with multiple models, aspect ratios from 1:1 to 21:9, up to 4K.",
  },
  {
    n: "03",
    title: "Video Generation",
    sub: "Megsy Video",
    desc: "Text-to-video and image-to-video. Durations from 5 to 10 seconds, with audio support.",
  },
  {
    n: "04",
    title: "Code Builder",
    sub: "Apps & Web",
    desc: "Describe what you want and Megsy builds and deploys a working web app inside a sandbox.",
  },
  {
    n: "05",
    title: "File Analysis",
    sub: "Documents & Data",
    desc: "Upload PDFs, images and documents — Megsy reads, extracts and answers questions about them.",
  },
];
...
const values = [
  ...
  },
  {
    ...
    desc: "We never train on your private projects. Delete your account and data any time from settings.",
  },
];
...
const AboutPage = () => {
  ...
  return (
    <div data-theme="dark" className="min-h-dvh overflow-x-hidden bg-background text-foreground">
      ...
      {/* HERO — landing style */}
      <section className="relative flex flex-col items-center overflow-hidden bg-background pb-10 pt-32 md:min-h-dvh md:pt-44">
        <div className="relative z-30 mx-auto w-full px-4 text-center">
          ...
          >
            Two founders. <span className="text-primary">One creative workspace.</span>
          </motion.h1>
          <motion.p
          ...
          >
            Chat, image, video, code and file analysis — built into a single workspace, priced in a
            single credit. Designed and built in Cairo.
          </motion.p>
          ...
          {founders.map((f, i) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent p-4 md:p-5">
                <p className="font-display text-sm font-bold text-foreground md:text-base">{f.name}</p>
                <p className="mt-0.5 text-[10px] uppercase tracking-wider text-foreground/70 md:text-xs">
                  {f.role}
                </p>
              </div>
            </motion.div>
        ...
        <div className="mx-auto grid max-w-6xl items-start gap-12 px-6 md:grid-cols-12 md:gap-16">
          ...
          >
            ...
            <h2 className="mt-4 font-display text-4xl uppercase leading-[0.95] tracking-tight text-foreground md:text-5xl">
              Too many tabs. <span className="text-primary">Too many subscriptions.</span>
            </h2>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <p>
              We are two founders, working from Cairo, building the tool we wished existed. Small
            ...
            {founders.map((f, i) => (
              ...
              >
                ...
                <div className="p-7 md:p-9">
                  ...
                  <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">{f.bio}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            >
              ...
              <p className="mt-6 max-w-xl text-base text-foreground/80 md:text-lg">
                We are not backed by a giant. We are two founders writing every line and answering
                every message — building the tool we needed ourselves.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden px-4 py-24 md:py-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            Try Megsy <span className="text-primary">for yourself.</span>
          </motion.h2>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row md:gap-4">
            ...
            >
              <span className="relative block rounded-full bg-black px-10 py-4 text-base font-semibold text-foreground">
                Get started
              </span>
            </button>
            <button
