...
const SERVICES: ServiceDetail[] = [
  ...
  },
  {
    ...
    media: { kind: "image", src: "/showcase/service-video-gen.webp", alt: "Video generation preview" },
    values: {
      Free: false,
              ...
              {SERVICES.map((s) => (
                <details key={s.name} className="rounded-2xl border border-border bg-card/70 p-4">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2 text-sm">
                    {TIERS.map((t) => (
                      <div key={t} className="rounded-xl border border-border/70 bg-background/50 p-3">
