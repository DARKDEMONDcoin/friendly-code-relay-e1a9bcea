    ...
    <div className="h-[100dvh] bg-background overflow-y-auto">
      <div className="max-w-lg mx-auto pb-16 px-5">
        ...
        <p className="text-xs text-muted-foreground mb-4 px-1">
          Agents Specialists generated automatically by AI for your tasks. Each agent activates when
          it finds a task in its specialty.
        </p>
        ...
        {loading ? (
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-2.5">
            {agents.map((a) => (
              <div
                key={a.id}
                className="p-4 rounded-2xl bg-muted/30 border border-border/30 flex items-start gap-3"
              >
                <div
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg hover:bg-destructive/10 flex items-center justify-center text-destructive/70 hover:text-destructive"
                >
