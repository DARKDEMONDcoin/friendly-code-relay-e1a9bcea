    ...
    return (
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          <CartoonFlag country={lang.country} size={36} />
          <div className="min-w-0">
            <p className="text-[14px] truncate" style={{ color: TEXT, fontWeight: 800 }}>{lang.name}</p>
            <p
      ...
      <div className="mt-3">
        ...
        <CartoonCard className="!p-0 overflow-hidden">
          <div className="divide-y" style={{ borderColor: "hsl(var(--surface-4))" }}>
            {LANGUAGES.map((l) => (
              <div key={l.code} style={{ borderColor: "hsl(var(--surface-4))" }} className="border-t first:border-t-0">
                <MobileRow lang={l} />
              </div>
            ))}
          </div>
