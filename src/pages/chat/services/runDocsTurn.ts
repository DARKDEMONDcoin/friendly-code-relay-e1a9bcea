...
export async function runDocsTurn(args: RunDocsTurnArgs): Promise<boolean> {
  const {
    userInput, localTurnId, chatUserId, navigate, messages,
    setMessages, setSearchStatus, setIsLoading, setIsThinking, resetToolUi,
    startDocsStatusFallback, stopDocsStatusFallback,
