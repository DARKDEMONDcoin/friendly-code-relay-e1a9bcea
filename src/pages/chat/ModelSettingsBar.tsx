...
import { MediaSettingsPanel, type MediaMode, type MediaSettings } from "@/components/chat/mobile/MediaSettingsMenu";
    ...
    <div className="w-full flex flex-col items-stretch">
      <div className="flex w-full items-center gap-3">
        <div className="flex-1 min-w-0 flex items-center">
          <ComposerModelMenu {...wrappedModelMenuProps} variant="segment" side="bottom" align="start" />
        </div>
        <button
          type="button"
          onClick={() => setOpen((o) => !o)}
        ...
        >
          <Settings2 className={`h-4 w-4 text-brand-action transition-transform duration-300 ${open ? "rotate-90" : ""}`} />
