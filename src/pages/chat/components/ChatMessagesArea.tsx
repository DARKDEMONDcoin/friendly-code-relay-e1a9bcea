...
export const ChatMessagesArea = forwardRef<HTMLDivElement, ChatMessagesAreaProps>(
  function ChatMessagesArea(props, messagesEndRef) {
    ...
    return (
      <div
        className={`flex-1 min-h-0 relative ${isEmpty ? "overflow-hidden" : "overflow-y-auto"}`}
      ...
      >
        ...
        {loadingMessages && messages.length === 0 ? (
          ...
          <div className="absolute inset-0 z-[1] md:flex md:items-center md:justify-center md:px-6 md:pt-0 md:pb-[190px]">
