...
export default function MegsyOsIntroBody({ onClose, isProPlusPlan, navigate, handleModeChange, icons }: MegsyOsIntroBodyProps) {
  ...
  return (
    <>
                    ...
                    },
                    {
                      ...
                      glyph: (
                        <svg viewBox="0 0 100 100" className="w-full h-full">
                          ...
                          <path
                            d="M50 44 L74 56 L62 60 L70 74 L64 76 L56 62 L48 68 Z"
                            fill="#1a1a1a"
                          />
                        </svg>
                      ),
            ...
            >
              <div
                className="pointer-events-auto relative w-full max-w-[1180px] max-h-[92vh] overflow-y-auto rounded-ios-lg border border-white/[0.08] shadow-[0_30px_120px_-20px_rgba(79,70,229,0.45)]"
                style={{
                  fontFamily: "'Hind', 'Inter', system-ui, sans-serif",
                  background:
                    "radial-gradient(120% 80% at 50% 0%, #1e1e5a 0%, #141432 38%, #0a0a1a 100%)",
                }}
                dir="ltr"
              >
                <div
                  ...
                  style={{
                    ...
                    WebkitMaskImage:
                      "radial-gradient(ellipse at 50% 0%, #000 35%, transparent 75%)",
                  }}
                />
                <div
                  aria-hidden
                ...
                <button
                  onClick={() => onClose()}
                  aria-label="Close"
                  className="absolute top-5 right-5 z-10 w-9 h-9 rounded-full flex items-center justify-center border border-white/15 bg-white/[0.04] text-foreground/80 hover:text-foreground hover:bg-white/[0.10] transition-colors"
                >
                  <X className="w-4 h-4" />
                </button>
                ...
                <div className="relative px-14 pt-16 pb-10 text-center">
                  <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-indigo-400/30 bg-indigo-500/10 backdrop-blur-sm">
                    ...
                    <span
                      className="text-[10.5px] font-bold tracking-[0.22em] text-indigo-200 uppercase"
                  ...
                  <h2
                    ...
                    className="mt-5 text-[64px] leading-[0.95] text-foreground uppercase"
                  >
                    What Megsy{" "}
                    <span
                      style={{
                  ...
                  <p className="mx-auto mt-4 max-w-[560px] text-[14.5px] leading-relaxed text-foreground/60">
                    Your autonomous AI computer — a full team that browses, builds, designs and
                    ships finished work straight to your chat, 24/7.
                  </p>
                  <div className="mt-7 flex items-center justify-center gap-3">
                    <button
                      onClick={() => onClose()}
                      className="px-6 py-3 rounded-full text-[13.5px] font-semibold text-foreground/80 hover:text-foreground border border-white/15 bg-white/[0.03] hover:bg-white/[0.08] transition-colors"
                    >
                      Maybe later
                    </button>
                    <button
                      ...
                      className="px-7 py-3 rounded-full text-[13.5px] font-bold text-foreground transition-all hover:-translate-y-[1px] active:translate-y-0"
                      style={{
                        ...
                        boxShadow:
                          "0 10px 28px -8px rgba(79,70,229,0.7), inset 0 1px 0 rgba(255,255,255,0.25)",
                      }}
                    >
                      {isProPlusPlan() ? "START NOW →" : "UPGRADE TO PRO →"}
                    </button>
                ...
                <div className="relative px-10 pb-12 grid grid-cols-3 gap-4">
                  {[
                    ...
                    },
                    {
                      ...
                      accent: "#a78bfa",
                      d: "Studio-grade images, reports, decks and full business strategies ready to send to clients.",
                      icon: <FileText className="w-5 h-5" strokeWidth={2.2} />,
                    },
                    {
                      t: "RUNS 24/7",
                      role: "The engine",
                      accent: "#4f46e5",
                      d: "Works in the background — close the app and come back to finished tasks waiting for you.",
                      icon: <Timer className="w-5 h-5" strokeWidth={2.2} />,
                    },
                    ...
                    <motion.div
                      ...
                      style={{
                        background:
                          "linear-gradient(180deg, rgba(30,30,90,0.45) 0%, rgba(20,20,50,0.55) 100%)",
                    ...
                    >
                      ...
                      <h3
                        className="text-foreground uppercase mt-1"
                        style={{
                          fontFamily: "'Archivo Black', sans-serif",
                          fontSize: "26px",
                          lineHeight: "1.02",
                      ...
                      <p className="text-[13px] leading-relaxed text-foreground/60">{d}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
