...
const BillingSuccessPage = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const data = {
          status: params.get("status") === "active" || params.get("status") === "succeeded" ? "succeeded" : "open",
  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="relative rounded-ios-lg border border-border/60 bg-card/80 backdrop-blur-xl shadow-2xl shadow-black/10 overflow-hidden">
            {/* Top gradient bar */}
            <div
              className={
                "h-1.5 w-full " +
            ...
            <div className="p-7 sm:p-10 text-center">
              ...
              {status === "pending" && (
                <>
                  ...
                  <p className="text-muted-foreground mb-6">
                    This usually finishes within a minute. We'll activate your subscription
                    automatically.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-2 justify-center">
                    <button
              ...
              {status === "failed" && (
                <>
                  ...
                  <p className="text-muted-foreground mb-6">
                    If you were charged, the amount will be refunded automatically within a few
                    days.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-2 justify-center">
                    <button
          ...
          <p className="text-center text-xs text-muted-foreground mt-4">
            Need help? Contact{" "}
            <a href="mailto:support@megsyai.com" className="underline hover:text-foreground">
              support@megsyai.com
            </a>
          </p>
        </motion.div>
