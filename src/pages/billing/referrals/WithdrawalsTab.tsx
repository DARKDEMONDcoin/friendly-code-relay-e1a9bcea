      ...
      >
        <div className="flex items-start justify-between gap-3">
          <div className="max-w-[60%]">
            ...
            <p className="mt-3 text-[12px] uppercase tracking-wider" style={{ fontWeight: 800, color: INK, opacity: 0.7 }}>
              Ready to withdraw
            </p>
        ...
        <div className="mt-4" style={{ color: INK }}>
          <div className="flex items-center justify-between text-[12px]" style={{ fontWeight: 800 }}>
            ...
            <span className="tabular-nums">${available.toFixed(0)} / ${MIN_PAYOUT}</span>
          </div>
          <div
              ...
              {wds.map((w) => (
                <li key={w.id} className="flex items-center justify-between py-3" style={{ borderColor: BORDER }}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[14.5px] tabular-nums" style={{ fontWeight: 900, color: TEXT }}>
