...
import {
  PAGE_BG, SURFACE, SURFACE_2, BORDER, TEXT, MUTED, INK, YELLOW, MINT, PINK, LAVENDER, PEACH,
} from "./ReferralsPage";
      ...
      <main className="mx-auto w-full max-w-2xl px-5 pb-20 pt-4">
        ...
        <section className="mt-8">
          <div className="mb-3 flex items-center gap-2">
            ...
            <h2 className="text-[14px] uppercase tracking-wider" style={{ fontWeight: 800, color: TEXT }}>
              Videos
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {IMAGES.map((it) => (
              <div
                ...
                style={{ backgroundColor: SURFACE, border: `2px solid ${BORDER}` }}
              >
                <div className="relative aspect-square w-full overflow-hidden" style={{ backgroundColor: SURFACE_2 }}>
                  <img
                    src={it.asset.url}
                    alt={it.title}
                    loading="lazy"
